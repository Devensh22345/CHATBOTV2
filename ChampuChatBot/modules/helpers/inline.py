...
from ChampuChatBot import OWNER, ChampuChatBot
...
START_BOT = [
    [
        InlineKeyboardButton(
            ...
            url=f"https://t.me/{ChampuChatBot.username}?startgroup=true",
        ),
    ],
    [
...
HELP_BUTN = [
    [
        InlineKeyboardButton(
            text="❍ 𝐇ᴇʟᴘ ❍", url=f"https://t.me/{ChampuChatBot.username}?start=help"
        ),
        InlineKeyboardButton(text="❍ 𝐂ʟᴏ𝐬ᴇ ❍", callback_data="CLOSE"),
    ],
]
